...
def drawBiomes(window, biomeDict, polygonDict):
	...
	for poly in biomeDict:
		if biomeDict[poly] != 'ocean':
			biome = biomeDict[poly]
			polygon = polygonDict[poly]

			try:
				if biome == "Snow":
					pygame.gfxdraw.filled_polygon(window, polygon, (255, 255, 255))

				elif biome == "Tundra":
					pygame.gfxdraw.filled_polygon(window, polygon, (112, 138, 144))

				elif biome == "Taiga":
					pygame.gfxdraw.filled_polygon(window, polygon, (34, 139, 34))

				elif biome == "Temperate Rain Forest":
					pygame.gfxdraw.filled_polygon(window, polygon, (50, 170, 162))

				elif biome == "Tropical Rain Forest":
					pygame.gfxdraw.filled_polygon(window, polygon, (90, 200, 120))

				elif biome == "Temperate Seasonal Forest":
					pygame.gfxdraw.filled_polygon(window, polygon, (40, 180, 35))

				elif biome == "Temperate Deciduous Forest":
					pygame.gfxdraw.filled_polygon(window, polygon, (46, 177, 83))

				elif biome == "Grassland":
					pygame.gfxdraw.filled_polygon(window, polygon, (66, 197, 103))

				elif biome == "Desert":
					pygame.gfxdraw.filled_polygon(window, polygon, (250, 219, 7))
