...
public class LunchDbAdapter {
	...
	private static final String DB_TABLE = "Lunch";
	private Context context;
	private SQLiteDatabase db;
	private LunchDatabaseHelper dbHelper;
	...
	public LunchDbAdapter open() throws SQLException {
		dbHelper = new LunchDatabaseHelper(context);
	...
	//create a new entry in the table lunch
	
	public long createLunch(String title, String address, String postcode, String phone, 
	...
	//update an entry in the table lunch
	
	public boolean updateLunch(long rowId, String title, String address, String postcode, String phone,
			                  String web, String distance, String cuisine, String bookable, String rating) {
		ContentValues values = createContentValues(title, address, postcode, phone, web,
												   distance, cuisine, bookable, rating);
	...
	//delete an entry in the table lunch

	public boolean deleteLunch(long rowId) {
		return db.delete(DB_TABLE, KEY_ROWID + "=" + rowId, null) > 0;
	}

	
	//return a cursor over all items in lunch
	
	public Cursor fetchAllLunch() {
	...
	//return a cursor at a specific lunch
	
	public Cursor fetchLunch(long rowId) throws SQLException {
