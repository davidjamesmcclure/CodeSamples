...
public class LunchTable {
	...
	private static final String DATABASE_CREATE = "create table Lunch "
	...
	public static void onUpgrade(SQLiteDatabase database, int oldVersion,
			int newVersion) {
		Log.w(LunchTable.class.getName(), "Upgrading database from version "
				+ oldVersion + " to " + newVersion
				+ ", which will destroy all old data");
		database.execSQL("DROP TABLE IF EXISTS Lunch");
		onCreate(database);
	}
}
