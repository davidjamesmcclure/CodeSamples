...
public class HotelDbAdapter {
	...
	public long createHotel(String title, String address, String postcode, String phone, 
						    String web, String distance, String rating) {
	...
	public boolean updateHotel(long rowId, String title, String address, String postcode, String phone,
			                  String web, String distance, String rating) {
		ContentValues values = createContentValues(title, address, postcode, phone, web,
												   distance, rating);
	...
	public Cursor fetchHotel(long rowId) throws SQLException {
		Cursor mCursor = db.query(true, DB_TABLE, new String[] { KEY_ROWID, KEY_TITLE, 
				...
				KEY_WEB, KEY_DISTANCE, KEY_RATING }, KEY_ROWID + "=" + rowId, null, null, null, null, null);
		if (mCursor != null) {
			mCursor.moveToFirst();
		}
		return mCursor;
